...
const ADMIN_LINKS = [
  ...
  { key: 'adminContacts', href: '/admin/contacts', icon: Mail },
  { key: 'adminSubscriptions', href: '/admin/subscriptions', icon: CreditCard },
  { key: 'adminBrands', href: '/admin/brands', icon: Building },
