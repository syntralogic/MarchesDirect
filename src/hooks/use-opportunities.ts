...
export function useOpportunities(params: OpportunitySearchParams['journey'] | OpportunitySearchParams) {
  ...
  const { journey, region, city, department, trade_id, q, status, min_value, max_value, recent_days, sort } = searchParams;
  ...
  }, [journey, region, city, department, trade_id, q, status, min_value, max_value, recent_days, sort]);
  ...
  const loadMore = useCallback(() => {
    ...
    opportunitiesApi
      .search({ journey, region, city, department, trade_id, q, status, min_value, max_value, recent_days, sort, page: nextPage, limit: PAGE_SIZE })
      .then((data) => {
  ...
  }, [journey, region, city, department, trade_id, q, status, min_value, max_value, recent_days, sort, page, totalPages, loadingMore]);
